...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../src/BinaryFeedback/index.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../src/BinaryFeedback/index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.BinaryFeedback = void 0;
...
var genClassName = function genClassName(className) {
  return "BinaryFeedback__".concat(className);
};
/*
Props:
...
/*#__PURE__*/
function (_Component) {
  _inherits(BinaryFeedback, _Component);

  function BinaryFeedback(props) {
    var _this;

    _classCallCheck(this, BinaryFeedback);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(BinaryFeedback).call(this, props));
    _this.state = {
      selected: 0
    };
    _this.onClickPositive = _this.onClickPositive.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.onClickNegative = _this.onClickNegative.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.renderPositiveContent = _this.renderPositiveContent.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.renderNegativeContent = _this.renderNegativeContent.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }

  _createClass(BinaryFeedback, [{
    key: "onClickPositive",
    value: function onClickPositive() {
    ...
    key: "onClickNegative",
    value: function onClickNegative() {
      if (!this.props.singleSelect || this.state.selected === 0) {
        this.setState({
          selected: 2
        });
    ...
    key: "renderPositiveContent",
    value: function renderPositiveContent() {
      if (this.props.positiveContent) {
        return this.props.positiveContent;
      }

      return _react.default.createElement(ThumbsUp, {
        className: genClassName('icon')
      });
    }
  }, {
    key: "renderNegativeContent",
    value: function renderNegativeContent() {
      if (this.props.negativeContent) {
        return this.props.negativeContent;
      }

      return _react.default.createElement(ThumbsDown, {
        className: genClassName('icon')
      });
    }
  }, {
    ...
    value: function render() {
      var positiveClass = genClassName('positive');
      var negativeClass = genClassName('negative');

      if (this.state.selected === 1) {
        positiveClass = "".concat(positiveClass, " ").concat(genClassName('selected'));

        if (this.props.singleSelect) {
          negativeClass = "".concat(negativeClass, " ").concat(genClassName('disabled'));
        }
      } else if (this.state.selected === 2) {
        negativeClass = "".concat(negativeClass, " ").concat(genClassName('selected'));

        if (this.props.singleSelect) {
          positiveClass = "".concat(positiveClass, " ").concat(genClassName('disabled'));
        }
      }

      return _react.default.createElement("div", {
        className: genClassName('container')
      }, _react.default.createElement("div", {
        className: genClassName('actions')
      }, _react.default.createElement("div", {
        className: positiveClass,
        onClick: this.onClickPositive,
        role: "button",
        tabIndex: 0
      }, this.renderPositiveContent()), _react.default.createElement("div", {
...
exports.BinaryFeedback = BinaryFeedback;
},{"react":"../node_modules/react/index.js","./index.scss":"../src/BinaryFeedback/index.scss"}],"index.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
var _BinaryFeedback = require("../src/BinaryFeedback");
...
var App = function App() {
  return _react.default.createElement("div", {
    ...
    className: "doc-title"
  }, "React Simple Feedback"), _react.default.createElement("div", {
    className: "doc-subtitle"
  }, _react.default.createElement("a", {
    href: "https://github.com/Teddarific/react-simple-feedback",
    target: "_blank",
    rel: "noopener noreferrer"
  }, " Github Repository ")), _react.default.createElement("div", {
    className: "doc-subtitle"
  }, "Author: ", _react.default.createElement("a", {
    href: "https://github.com/Teddarific",
    target: "_blank",
    rel: "noopener noreferrer"
  }, " Teddy Ni ")), _react.default.createElement("div", {
    className: "doc-subtitle"
  }, "Licensed under MIT"), _react.default.createElement("div", {
    className: "doc-components"
  }, _react.default.createElement("div", {
    className: "doc-component"
  }, _react.default.createElement("div", {
    className: "doc-component-title"
  }, "Binary Feedback"), _react.default.createElement("div", {
    className: "doc-component-component"
  }, _react.default.createElement(_BinaryFeedback.BinaryFeedback, null)))));
};

_reactDom.default.render(_react.default.createElement(App, null), document.getElementById('root'));
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","../src/BinaryFeedback":"../src/BinaryFeedback/index.js","./index.scss":"index.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/docs.e31bb0bc.map